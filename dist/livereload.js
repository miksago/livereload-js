...
__reloader.Reloader = Reloader = (function() {
  ...
  Reloader.prototype.reload = function(path, options) {
    var plugin, _base, _i, _len, _ref, _ref2;
    this.options = options;
  ...
  Reloader.prototype.reloadStylesheet = function(path) {
    var imported, link, links, match, style, _i, _j, _k, _l, _len, _len2, _len3, _len4, _ref, _ref2;
    links = (function() {
      var _i, _len, _ref, _results;
    ...
    if (this.window.StyleFix && this.document.querySelectorAll) {
      _ref2 = this.document.querySelectorAll('style[data-href]');
    ...
    match = pickBestMatch(path, links.concat(imported), __bind(function(l) {
    ...
    if (match) {
      ...
      for (_l = 0, _len4 = links.length; _l < _len4; _l++) {
        link = links[_l];
  ...
  Reloader.prototype.waitUntilCssLoads = function(clone, func) {
    ...
    executeCallback = __bind(function() {
      if (callbackExecuted) {
        return;
      }
    ...
    clone.onload = __bind(function() {
      this.knownToSupportCssOnLoad = true;
      return executeCallback();
    }, this);
    if (!this.knownToSupportCssOnLoad) {
      (poll = __bind(function() {
        if (clone.sheet) {
          return executeCallback();
        } else {
  ...
  Reloader.prototype.reattachStylesheetLink = function(link) {
    ...
    return this.waitUntilCssLoads(clone, __bind(function() {
      ...
      return this.Timer.start(additionalWaitingTime, __bind(function() {
        var _ref;
        if (!link.parentNode) {
          return;
        }
        ...
        return (_ref = this.window.StyleFix) != null ? _ref.link(clone) : void 0;
      }, this));
    }, this));
  };
...
__livereload.LiveReload = LiveReload = (function() {
  ...
  LiveReload.prototype.performReload = function(message) {
    ...
    if (typeof (_base = this.listeners).reload === "function") {
      _base.reload();
    }
...
LiveReload.on('connect', function() {
  var css, declaration, declarations, head, prefix, style;
  ...
  declarations = ((function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      prefix = _ref[_i];
      _results.push(prefix + declaration);
    }
    return _results;
  })()).join(' ');
...
LiveReload.on('reload', function() {
  var currentHtmlClass, html, loadingClass, _ref;
  html = document.body.parentNode;
  loadingClass = ' livereload-loading';
  currentHtmlClass = (_ref = html.getAttribute('class')) != null ? _ref : '';
  html.setAttribute('class', currentHtmlClass.replace(loadingClass, '') + ("" + loadingClass));
  return setTimeout((function() {
    return html.setAttribute('class', currentHtmlClass.replace(loadingClass, ''));
  }), 300);
});
